      ...
      <CardContent className="p-5">
        ...
        >
          <Button 
            variant="outline" 
            size="sm"
            className="w-full border-slate-600 text-slate-300 hover:bg-slate-700 hover:text-white hover:border-slate-500 transition-all"
          >
          ...
          <TabsList className="flex flex-wrap h-auto gap-2 bg-transparent p-0 mb-6">
            {categories.map((category) => (
              ...
              >
                ...
                <Badge variant="secondary" className="ml-1 text-xs bg-slate-700/50 text-slate-500">
